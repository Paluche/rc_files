...
" GNOME Library
syn keyword cType gboolean
syn keyword cType gchar gint gshort glong
syn keyword cType guchar guint gushort gulong
syn keyword cType gint8 gint16 gint32 gint64
syn keyword cType guint8 guint16 guint32 guint64
syn keyword cType gfloat gdouble
syn keyword cType gsize gssize goffset
syn keyword cType gpointer gconstpointer gintptr guinptr
syn keyword cType GSList GList GThread GError GIOChannel GMutex GQuark
syn keyword cType GAttrib GAttribResultFunc GAttribNotifyFunc
...
if !exists("c_no_ansi") || exists("c_ansi_constants") || exists("c_gnu")
  ...
  syn keyword cConstant EAGAIN EALREADY EBADE EBADF EBADFD EBADMSG EBADR EBADRQC
  syn keyword cConstant EBADSLT EBUSY ECANCELED ECHILD ECHRNG ECOMM ECONNABORTED
  syn keyword cConstant ECONNREFUSED ECONNRESET EDEADLK EDEADLOCK EDESTADDRREQ
  syn keyword cConstant EDOM EDQUOT EEXIST EFAULT EFBIG EHOSTDOWN EHOSTUNREACH
  syn keyword cConstant EIDRM EILSEQ EINPROGRESS EINTR EINVAL EIO EISCONN EISDIR
  syn keyword cConstant EISNAM EKEYEXPIRED EKEYREJECTED EKEYREVOKED EL2HLT
  syn keyword cConstant EL2NSYNC EL3HLT EL3RST ELIBACC ELIBBAD ELIBMAX ELIBSCN
  syn keyword cConstant ELIBEXEC ELOOP EMEDIUMTYPE EMFILE EMLINK EMSGSIZE
  syn keyword cConstant EMULTIHOP ENAMETOOLONG ENETDOWN ENETRESET ENETUNREACH
  syn keyword cConstant ENFILE ENOBUFS ENODATA ENODEV ENOENT ENOEXEC ENOKEY
  syn keyword cConstant ENOLCK ENOLINK ENOMEDIUM ENOMEM ENOMSG ENONET ENOPKG
  syn keyword cConstant ENOPROTOOPT ENOSPC ENOSR ENOSTR ENOSYS ENOTBLK ENOTCONN
  syn keyword cConstant ENOTDIR ENOTEMPTY ENOTSOCK ENOTSUP ENOTTY ENOTUNIQ ENXIO
  syn keyword cConstant EOPNOTSUPP EOVERFLOW EPERM EPFNOSUPPORT EPIPE EPROTO
  syn keyword cConstant EPROTONOSUPPORT EPROTOTYPE ERANGE EREMCHG EREMOTE
  syn keyword cConstant EREMOTEIO ERESTART EROFS ESHUTDOWN ESPIPE
  syn keyword cConstant ESOCKTNOSUPPORT ESRCH ESTALE ESTRPIPE ETIME ETIMEDOUT
  syn keyword cConstant ETXTBSY EUCLEAN EUNATCH EUSERS EWOULDBLOCK EXDEV EXFULL
  " math.h
...
syn keyword	cAnsiName	errno environ optarg
